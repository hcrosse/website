...
import { installPdfs, prepareOutputs, removeTemporaryPdfs, type ResumeOutput } from "./resume/files"
...
async function renderAndInstall(
  ...
  try {
    ...
    primaryError = cause instanceof Error ? cause : new Error("Resume generation failed", { cause })
  }
