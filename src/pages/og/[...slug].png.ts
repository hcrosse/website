...
const fonts = {
  regular: fs.readFileSync(path.join(fontsDir, "BerkeleyMono-Regular.otf")).buffer as ArrayBuffer,
  bold: fs.readFileSync(path.join(fontsDir, "BerkeleyMono-Bold.otf")).buffer as ArrayBuffer,
};
